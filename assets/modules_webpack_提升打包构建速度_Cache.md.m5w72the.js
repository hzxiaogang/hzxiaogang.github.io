import{_ as n,o as a,c as l,ak as p}from"./chunks/framework.DLt_otXO.js";const F=JSON.parse('{"title":"Cache","description":"","frontmatter":{"title":"Cache","date":"2022-07-09T15:56:31.000Z","permalink":"/pages/4da420/","categories":["modules","webpack","高级","提升打包构建速度"],"tags":[null]},"headers":[],"relativePath":"modules/webpack/提升打包构建速度/Cache.md","filePath":"modules/webpack/提升打包构建速度/Cache.md","lastUpdated":1777258973000}'),o={name:"modules/webpack/提升打包构建速度/Cache.md"};function e(t,s,c,E,r,y){return a(),l("div",null,[...s[0]||(s[0]=[p(`<h2 id="_1-为什么" tabindex="-1">1. 为什么 <a class="header-anchor" href="#_1-为什么" aria-label="Permalink to “1. 为什么”">​</a></h2><p>每次打包时 <code>js</code>文件都要经过 <code>Eslint\`\` 检查 和</code>Babel \`编译，速度比较慢。</p><p>我们可以缓存之前的 <code>Eslint</code>检查 和 <code>Babel</code>编译结果，这样第二次打包时速度就会更快了。</p><h2 id="_2-是什么" tabindex="-1">2. 是什么 <a class="header-anchor" href="#_2-是什么" aria-label="Permalink to “2. 是什么”">​</a></h2><p>对 <code>Eslint</code>检查 和<code>Babel</code>编译结果进行缓存。</p><h2 id="_3-怎么用" tabindex="-1">3. 怎么用 <a class="header-anchor" href="#_3-怎么用" aria-label="Permalink to “3. 怎么用”">​</a></h2><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8;" tabindex="0" dir="ltr"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#79B8FF;"> path</span><span style="color:#F97583;"> =</span><span style="color:#B392F0;"> require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;path&quot;</span><span style="color:#E1E4E8;">);</span></span>
...
<span class="line highlighted"><span style="color:#E1E4E8;">              cacheCompression: </span><span style="color:#79B8FF;">false</span><span style="color:#E1E4E8;">, </span><span style="color:#6A737D;">// 缓存文件不要压缩</span></span>
...
<span class="line highlighted"><span style="color:#E1E4E8;">      cache: </span><span style="color:#79B8FF;">true</span><span style="color:#E1E4E8;">, </span><span style="color:#6A737D;">// 开启缓存</span></span>
<span class="line highlighted"><span style="color:#6A737D;">      // 缓存目录</span></span>
<span class="line highlighted"><span style="color:#E1E4E8;">      cacheLocation: path.</span><span style="color:#B392F0;">resolve</span><span style="color:#E1E4E8;">(</span></span>
<span class="line highlighted"><span style="color:#E1E4E8;">        __dirname,</span></span>
<span class="line highlighted"><span style="color:#9ECBFF;">        &quot;../node_modules/.cache/.eslintcache&quot;</span></span>
<span class="line highlighted"><span style="color:#E1E4E8;">      ),</span></span>
<span class="line"><span style="color:#E1E4E8;">    }),</span></span>
