import{_ as n,o as a,c as l,ak as p}from"./chunks/framework.DLt_otXO.js";const F=JSON.parse('{"title":"处理htlm资源","description":"","frontmatter":{"title":"处理htlm资源","date":"2022-07-09T11:42:10.000Z","permalink":"/pages/874557/","categories":["modules","webpack","基础"],"tags":[null]},"headers":[],"relativePath":"modules/webpack/基础/处理htlm资源.md","filePath":"modules/webpack/基础/处理htlm资源.md","lastUpdated":1777258973000}'),o={name:"modules/webpack/基础/处理htlm资源.md"};function e(t,s,c,E,r,y){return a(),l("div",null,[...s[0]||(s[0]=[p(`<h2 id="_1-下载包" tabindex="-1">1. 下载包 <a class="header-anchor" href="#_1-下载包" aria-label="Permalink to “1. 下载包”">​</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8;" tabindex="0" dir="ltr"><code><span class="line"><span style="color:#B392F0;">npm</span><span style="color:#9ECBFF;"> i</span><span style="color:#9ECBFF;"> html-webpack-plugin</span><span style="color:#79B8FF;"> -D</span></span></code></pre></div><h2 id="_2-功能介绍" tabindex="-1">2. 功能介绍 <a class="header-anchor" href="#_2-功能介绍" aria-label="Permalink to “2. 功能介绍”">​</a></h2><ul><li>html-webpack-plugin ：将打包后的<code>bundle</code>自动导入到<code>html</code>中</li></ul><h2 id="_3-配置" tabindex="-1">3. 配置 <a class="header-anchor" href="#_3-配置" aria-label="Permalink to “3. 配置”">​</a></h2><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8;" tabindex="0" dir="ltr"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#79B8FF;"> path</span><span style="color:#F97583;"> =</span><span style="color:#B392F0;"> require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;path&quot;</span><span style="color:#E1E4E8;">);</span></span>
...
<span class="line highlighted"><span style="color:#F97583;">const</span><span style="color:#79B8FF;"> HtmlWebpackPlugin</span><span style="color:#F97583;"> =</span><span style="color:#B392F0;"> require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;html-webpack-plugin&quot;</span><span style="color:#E1E4E8;">);</span></span>
...
<span class="line"><span style="color:#E1E4E8;">    }),</span></span>
<span class="line highlighted"><span style="color:#F97583;">    new</span><span style="color:#B392F0;"> HtmlWebpackPlugin</span><span style="color:#E1E4E8;">({</span></span>
<span class="line highlighted"><span style="color:#6A737D;">      // 以 public/index.html 为模板创建文件</span></span>
<span class="line highlighted"><span style="color:#6A737D;">      // 新的html文件有两个特点：1. 内容和源文件一致 2. 自动引入打包生成的js等资源</span></span>
<span class="line highlighted"><span style="color:#E1E4E8;">      template: path.</span><span style="color:#B392F0;">resolve</span><span style="color:#E1E4E8;">(__dirname, </span><span style="color:#9ECBFF;">&quot;public/index.html&quot;</span><span style="color:#E1E4E8;">),</span></span>
...
<span class="line"><span style="color:#E1E4E8;">};</span></span></code></pre></div><h2 id="_4-html-压缩" tabindex="-1">4. html 压缩 <a class="header-anchor" href="#_4-html-压缩" aria-label="Permalink to “4. html 压缩”">​</a></h2><p>生产模式默认开启了<code>html</code>压缩</p>`,8)])])}const u=n(o,[["render",e]]);export{F as __pageData,u as default};
